...
CREATE INDEX `idx_access_grant_status` ON `access_grants` (`status`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_app_role_role` ON `app_role_assignments` (`role`);--> statement-breakpoint
CREATE UNIQUE INDEX `uq_app_role_user` ON `app_role_assignments` (`user_id`,`role`);
