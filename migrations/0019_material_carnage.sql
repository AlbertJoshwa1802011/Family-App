-- Idempotent: production may already have demo_requests / access_grants from an
-- earlier signup/access ship that was not recorded in D1's migrations table.
-- 0019 never successfully applied remotely, so editing it is safe.
