...
export function UpdateToast() {
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className="liquid-bubble liquid-chrome bubble-in fixed inset-x-0 bottom-24 z-40 mx-auto flex w-[calc(100%-2rem)] max-w-sm items-center gap-3 rounded-full px-4 py-3 md:bottom-6"
    >
