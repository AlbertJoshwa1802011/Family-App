    ...
    <>
      ...
      <Page className="space-y-6">
        <Card className="flex items-start gap-3 p-4">
          <div className="lq lq-tint lq-raised flex size-10 shrink-0 items-center justify-center rounded-full [--lq-tint:var(--color-vault-400)]">
            <Shield className="size-5 text-vault-300" aria-hidden="true" />
          </div>
          <div className="min-w-0 text-sm text-fg-muted">
            <p className="font-semibold text-white">Super admin</p>
            <p className="mt-1 leading-relaxed">
              Approve demo requests and invite teammates to the app. Family roles
              stay separate — this controls who can sign in at all.
            </p>
          </div>
        </Card>
        ...
        <section className="space-y-2">
          ...
          {requests.isLoading ? (
            ...
            <EmptyState
              ...
              description="New demo requests from the login page show up here."
            />
          ) : (
        ...
        <section className="space-y-2">
          ...
          {grants.isLoading ? (
            ...
            <EmptyState
              icon={UserPlus}
              title="No grants yet"
              description="Approved demos and direct invites appear here."
            />
          ) : (
