/**
 * Money Manager–style emoji for expense categories.
 * Built-ins keep lucide `icon` names in D1; the SPA/API decorate with emoji.
 * Custom categories may store an emoji string in `icon` (PascalCase = lucide).
 */
...
/** Lucide names are PascalCase ASCII; emojis / free text are not. */
